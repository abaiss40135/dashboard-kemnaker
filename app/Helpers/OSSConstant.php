...
class OSSConstant
{
    const ACCEPTED_ID_BIDANG = [
        982, 983, 984, 985, 986, 987
    ];

    const JENIS_PERUSAHAAN = [
        '01' => 'Perusahaan Terbatas (PT)',
        '02' => 'Perseroan Komanditer (CV)',
        ...
        '19' => 'Badan Hukum (selain PT,Yayasan dan Koperasi)',
    ];

    const STATUS_PERMODALAN = [
        '01' => 'Penanaman Modal Asing',
        '02' => 'Penanaman Modal Dalam Negeri',
        '03' => 'Bukan (PMA/PMDN)'
    ];

    const STATUS_BADAN_HUKUM = [
        '01' => 'Badan Hukum',
