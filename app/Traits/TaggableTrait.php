...
use App\Events\TagRemovedEvent as TagRemoved;
use App\Events\TagAddedEvent as TagAdded;
...
trait TaggableTrait
{
     ...
     * @return Collection|Tagged[]
     */
    public static function existingTagsInGroups(array $groups): Collection
    {
        $model = TaggingUtility::taggedModelString();
    ...
    {
        return static::$untagOnDelete ?? true;
    }
