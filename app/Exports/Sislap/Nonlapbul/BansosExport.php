...
class BansosExport implements FromView, ShouldAutoSize, WithEvents, WithStrictNullComparison
{
    use Exportable;

    private $bansosService;
    private $is_template;
    private $path = 'excel.template-laporan.bansos';
    ...
    public function view(): View
    {
        ...
        $collection = $this->bansosService->export(request());
