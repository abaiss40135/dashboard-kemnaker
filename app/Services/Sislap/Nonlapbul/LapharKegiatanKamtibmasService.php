...
class LapharKegiatanKamtibmasService implements ExportInterface
{
    ...
    protected function getQuery($request, $withApproval = null)
    {
        ...
        return LapharKegiatanKamtibmas::query()
        ->with('kegiatans','personel:user_id,personel_id,nama,satuan1,satuan2')
