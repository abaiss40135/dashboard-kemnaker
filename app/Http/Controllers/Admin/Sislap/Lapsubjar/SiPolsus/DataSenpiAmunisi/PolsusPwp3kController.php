...
class PolsusPwp3kController extends Controller
{
    ...
    {
        $this->service = new DataSenpiAmunisiService('polsus_pwp3k');
    }

    public function index()
    {
        return view('administrator.sislap.lapsubjar.si-polsus.data-senpi-amunisi.sub-menu.polsus-pwp3k', [
    ...
    public function exportExcel() {
        ...
        return Excel::download($template, 'Laporan Data Senpi dan Amunisi Polsus PWP3K - '.now()->translatedFormat(config('app.long_date_without_day_format')).'.xlsx');
    }
