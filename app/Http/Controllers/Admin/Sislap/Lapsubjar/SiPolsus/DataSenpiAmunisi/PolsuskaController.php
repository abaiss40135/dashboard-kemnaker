...
class PolsuskaController extends Controller
{
    ...
    {
        $this->service = new DataSenpiAmunisiService('polsuska');
    }

    public function index()
    {
        return view('administrator.sislap.lapsubjar.si-polsus.data-senpi-amunisi.sub-menu.polsuska', [
    ...
    public function exportExcel() {
        ...
        return Excel::download($template, 'Laporan Data Senpi Polsuska - '.now()->translatedFormat(config('app.long_date_without_day_format')).'.xlsx');
    }
