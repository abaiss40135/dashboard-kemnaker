...
class PolsusCagarBudayaController extends Controller
{
    ...
    {
        $this->service = new DataSenpiAmunisiService('polsus_cagar_budaya');
    }

    public function index()
    {
        return view('administrator.sislap.lapsubjar.si-polsus.data-senpi-amunisi.sub-menu.polsus-cagar-budaya', [
    ...
    public function exportExcel() {
        ...
        return Excel::download($template, 'Laporan Data Senpi dan Amunisi Polsus Cagar Budaya - '.now()->translatedFormat(config('app.long_date_without_day_format')).'.xlsx');
    }
