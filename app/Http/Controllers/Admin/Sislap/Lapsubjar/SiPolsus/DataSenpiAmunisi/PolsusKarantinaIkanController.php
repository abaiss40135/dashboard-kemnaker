...
class PolsusKarantinaIkanController extends Controller
{
    ...
    {
        $this->service = new DataSenpiAmunisiService('polsus_karantina_ikan');
    }

    public function index()
    {
        return view('administrator.sislap.lapsubjar.si-polsus.data-senpi-amunisi.sub-menu.polsus-karantina-ikan', [
    ...
    public function exportExcel() {
        ...
        return Excel::download($template, 'Laporan Data Senpi dan Amunisi Polsus Karantina Ikan - '.now()->translatedFormat(config('app.long_date_without_day_format')).'.xlsx');
    }
