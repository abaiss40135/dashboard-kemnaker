...
class DataAmunisiController extends Controller
{
    protected $model = DataAmunisi::class;
    private $service;
    ...
    public function index() {
        return view('administrator.sislap.lapsubjar.si-polsus.data-amunisi.index', [
    ...
    public function exportExcel() {
        ...
        return Excel::download($template, 'Laporan Data Amunisi Polsus - '.now()->translatedFormat(config('app.long_date_without_day_format')).'.xlsx');
    }
