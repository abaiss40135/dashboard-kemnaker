...
namespace App\Http\Controllers\Admin\Sislap\Lapsubjar\SiPolsus\DiklatKhusus;
...
class PejabatLingkunganKlController extends Controller
{
    use CustomPaginationTrait;

    private $service;
    private $jenjang_diklat = "khusus_pejabat_kl";
    ...
    public function index() {
        ...
        return view('administrator.sislap.lapsubjar.si-polsus.data-diklat-khusus.sub-menu.pejabat_lingkungan_kl', [
    ...
    public function exportExcel() {
        ...
        return Excel::download($template, 'Laporan Data Polsus Diklat Khusus Pejabat di Lingkungan Kementrian atau Lembaga - '.now()->translatedFormat(config('app.long_date_without_day_format')).'.xlsx');
    }
