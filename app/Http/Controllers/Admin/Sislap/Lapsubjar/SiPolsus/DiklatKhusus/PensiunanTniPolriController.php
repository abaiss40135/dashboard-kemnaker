...
class PensiunanTniPolriController extends Controller
{
    use CustomPaginationTrait;

    private $service;
    private $jenjang_diklat = "khusus_tni_polri";
    ...
    public function index() {
        ...
        return view('administrator.sislap.lapsubjar.si-polsus.data-diklat-khusus.sub-menu.pensiunan_tni_polri', [
    ...
    public function exportExcel() {
        ...
        return Excel::download($template, 'Laporan Data Polsus Diklat Khusus Pensiunan TNI/Polri - '.now()->translatedFormat(config('app.long_date_without_day_format')).'.xlsx');
    }
