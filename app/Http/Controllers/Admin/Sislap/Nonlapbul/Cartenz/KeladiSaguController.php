...
class KeladiSaguController extends Controller
{
    ...
    {
        $this->service = new OpsDamaiCartenzService(OpsDamaiCartenz::KELADI_SAGU);
    }

    public function index()
    {
        return view('administrator.sislap.nonlapbul.ops-damai-cartenz.keladi-sagu', [
    ...
    public function store(StoreOpsDamaiCartenzRequest $request)
    {
        ...
        if (empty($kode_satuan)) {
            ...
            ])->redirectTo(route('cartenz.keladi-sagu.index'));
        }
            ...
            DB::transaction(function () use ($level, $user, $validated, $kode_satuan) {
                foreach ($validated['laporan'] as $item) {
                    ...
                    ->updateOrCreate(
                        [
                            'daops' => $item['daops'],
                            'type'  => OpsDamaiCartenz::KELADI_SAGU,
                        ],
        ...
        return redirect()->route('cartenz.keladi-sagu.index');
    }
    ...
    public function templateExcel()
    {
        ...
        return (new OpsDamaiCartenzExport(OpsDamaiCartenz::KELADI_SAGU, true))
                ->download("FORMAT LAPHAR KELADI SAGU $notes ".now()->format("Y-m-d").".xlsx");
    }
    ...
    public function exportExcel()
    {
        ...
        return (new OpsDamaiCartenzExport(OpsDamaiCartenz::KELADI_SAGU))
            ->download('EKSPOR LAPHAR Keladi Sagu '.$notes.'.xlsx');
    }
