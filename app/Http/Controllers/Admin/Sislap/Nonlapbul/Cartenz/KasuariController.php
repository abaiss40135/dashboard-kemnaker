...
class KasuariController extends Controller
{
    ...
    {
        $this->service = new OpsDamaiCartenzService(OpsDamaiCartenz::KASUARI);
    }

    public function index()
    {
        return view('administrator.sislap.nonlapbul.ops-damai-cartenz.kasuari', [
    ...
    public function store(StoreOpsDamaiCartenzRequest $request)
    {
        ...
        if (empty($kode_satuan)) {
            ...
            ])->redirectTo(route('cartenz.kasuari.index'));
        }
        ...
        return redirect()->route('cartenz.kasuari.index');
    }
    ...
    public function templateExcel()
    {
        ...
        return (new OpsDamaiCartenzExport(OpsDamaiCartenz::KASUARI, true))
                ->download("FORMAT LAPHAR KASUARI $notes ".now()->format("Y-m-d").".xlsx");
    }
    ...
    public function exportExcel()
    {
        ...
        return (new OpsDamaiCartenzExport(OpsDamaiCartenz::KASUARI))
            ->download('EKSPOR LAPHAR KASUARI '.$notes.'.xlsx');
    }
