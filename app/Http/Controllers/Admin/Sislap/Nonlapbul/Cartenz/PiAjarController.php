...
class PiAjarController extends Controller
{
    ...
    {
        $this->service = new OpsDamaiCartenzService(OpsDamaiCartenz::PI_AJAR);
    }

    public function index()
    {
        return view('administrator.sislap.nonlapbul.ops-damai-cartenz.pi-ajar', [
    ...
    public function store(StoreOpsDamaiCartenzRequest $request)
    {
        ...
        if (empty($kode_satuan)) {
            ...
            ])->redirectTo(route('cartenz.pi-ajar.index'));
        }
        ...
        return redirect()->route('cartenz.pi-ajar.index');
    }
    ...
    public function templateExcel()
    {
        ...
        return (new OpsDamaiCartenzExport(OpsDamaiCartenz::PI_AJAR, true))
                ->download("FORMAT LAPHAR PiAjar $notes ".now()->format("Y-m-d").".xlsx");
    }
    ...
    public function exportExcel()
    {
        ...
        return (new OpsDamaiCartenzExport(OpsDamaiCartenz::PI_AJAR))
            ->download('EKSPOR LAPHAR PiAjar '.$notes.'.xlsx');
    }
