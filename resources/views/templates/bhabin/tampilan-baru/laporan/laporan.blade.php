...
<div class="container mx-auto mb-4 p-4 border border-3 border-primary" style="background-color: #BADAFF; border-radius: 15px;">
    <div class="d-flex justify-content-between">
        {{-- 7 Giat Wajib Harian --}}
        <div style="width: 18%;" class=" mt-4">
            <div class="box">
                <div class="header text-center">
                    <img src="{{ asset('img/bhabin/icon/laporan/giat.svg') }}" width="60px" class="d-block mx-auto" alt="" srcset="">
                    <h5 class="mt-3">7 Giat Wajib Harian</h5>
                </div>
        ...
        <div style="width: 18%;" class=" mt-4">
            <div class="box">
                <div class="header text-center">
                    ...
                    <h5 class="mt-3">Program Polri</h5>
                </div>
        ...
        <div style="width: 18%;" class=" mt-4">
            <div class="box">
                <div class="header text-center">
                    ...
                    <h5 class="mt-3 ">Atensi Pimpinan</h5>
                </div>
        ...
        <div style="width: 18%;" class=" mt-4">
            <div class="box">
                <div class="header text-center">
                    ...
                    <h5 class="mt-3 ">Insidentil, Kontinjensi & Kreatifitas</h5>
                </div>
                <div class="box-body">
                    <ul class="list-group text-center">
                        <li class="list-group-item">
