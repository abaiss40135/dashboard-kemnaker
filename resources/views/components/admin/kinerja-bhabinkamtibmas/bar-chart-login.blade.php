<div class="card">
    <div class="header">Rekapitulasi Bhabinkamtibmas Sudah Login Perdaerah
...
@push('scripts')
    <script>
        function initBarChart(rekapitulasi, listPolda, charElement) {
            new Chart(charElement.getContext('2d'), {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'jumlah bhabinkamtibmas',
                            data: rekapitulasi[0],
                            backgroundColor: "hsl(0, 10%, 10%)",
                        }, {
                            label: 'bhabinkamtibmas sudah login',
                            data: rekapitulasi[1],
        ...
        function initChartRekapitulasi(data) {
