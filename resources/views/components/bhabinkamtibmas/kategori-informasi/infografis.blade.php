<div>
    <div class="card-body p-0">
        <div id="infografis-content-wrapper" class="row row-cols-3" style="--bs-gutter-x: 0.7rem;"></div>
            ...
            content: (data) => {
                ...
                return `
                    <div class="col d-flex flex-column">
                        ...
                        <a class="btn btn-sm text-primary nav-text-small" style="background-color: #CFE5F2;"
