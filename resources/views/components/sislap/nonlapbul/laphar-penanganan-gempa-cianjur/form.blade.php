<div>
    <div class="jumbotron">
        <p class="lead text-bold">Format ini terkhusus untuk kegiatan penanganan gempa di wilayah Kabupaten Cianjur</p>
        <hr class="my-4">
...
@push('scripts')
    <script>
        ...
        const $form = $('#form-penanganan-pasca-gempa');
        ...
        function ignite() {
            ...
            function reducer(state, action) {
                ...
                switch (action) {
                    case "ADD":
                        state.data[state.position] = saveFormData('form-penanganan-pasca-gempa');
                    ...
                    case "SUBMIT":
                        ...
                        $.ajax({
                            url: route('penanganan-pasca-gempa-cianjur.store'),
                            method: 'post',
                            data: {
                            ...
                            success: function (response) {
                                ...
                                //delay 2 sec
                                setTimeout(function () {
                                    window.location.href = route('penanganan-pasca-gempa-cianjur.index');
                                }, 2000);
                            },
                        });
                        break;
