        ...
        <div class="col-md-6 mt-3">
            <div class="card">
                ...
                <div class="card-body text-center" id="wrapper-chart-laporan">
                    <canvas id="laporan-bhabinkamtibmas"
        ...
        (function () {
            ...
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    $('#wrapper-chart-laporan').html(`<canvas id="chart-laporan-bhabinkamtibmas"
                                            style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>`);

                    let data = response;

                    @if(can('chart_laporan_bhabinkamtibmas_access'))
                    const laporan = $('#chart-laporan-bhabinkamtibmas').get(0).getContext('2d');
                    const laporanData = {
            ...
            $.ajax({
                url: route('dashboard.dashboard-bhabinkamtibmas.get-rekap-bidang-informasi'),
                type: 'get',
                beforeSend: function () {
