@extends('templates.admin-lte.admin', ['title' => 'Terobosan Kreatif dan Inovatif'])
@section('customcss')
                ...
                <table class="table table-hover table-bordered" id="datatable">
                    <thead class="text-center">
                        <tr style="background-color: #1E4588">
                            ...
                            <th class="align-middle text-white">PIC/Penanggung Jawab</th>
...
@section('customjs')
    ...
    <script>
        ...
        document.querySelector('#form-search').addEventListener('submit', (evt) => {
            ...
            terobosanKreatifTable();
        });

        const datatable = $('#datatable')

        function terobosanKreatifTable () {
            generateDataTable({
                dom: 'rtip',
                selector: datatable,
                url: route('terobosan-kreatif.datatable'),
                order: [[6, 'desc']],
                data: function (d) {
        ...
        datatable.on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: route('terobosan-kreatif.destroy', id),
