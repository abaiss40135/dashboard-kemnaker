...
<div class="wrapper">
    <div class="content-wrapper">
        @component('components.admin.content-header')
            @slot('title', 'Laporan Data Pokdarkamtibmas')
        @endcomponent
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    @component('components.sislap.card-header')
                        @slot('template_excel', route('data-pokdarkamtibmas.template-excel'))
                        @slot('import_excel', route('data-pokdarkamtibmas.import-excel'))
                    @endcomponent
                    <div class="card-body">
                        @if(isset($laporan))
                        <div>
                            <h2 class="h4 text-center mb-3"><b>Preview Laporan Data Pokdarkamtibmas</b></h2>
                            <div class="table-responsive mb-4">
                                <form action="{{ route('data-pokdarkamtibmas.store') }}"
                        ...
                        @else
                        <div>
                            <h2 class="h4 text-center"><b>Laporan Data Pokdarkamtibmas</b></h2>
                            <form action="{{ route('data-pokdarkamtibmas.export-excel') }}"
                            ...
                            @component('components.sislap.form-search')
                                @slot('route', route('data-pokdarkamtibmas.export-excel'))
...
@section('customjs')
    ...
    <script>
        ...
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('data-pokdarkamtibmas.search'),
                data: {}
            },
                ...
                let table = `
                    <tr ${ haveApprovals && item.approval.is_approve === false ? 'class="bg-orange"': ''} ${ haveApprovals ? 'data-widget="expandable-table" aria-expanded="false"' : '' }>
                        ...
                        @can('sislap_approval_approve')
                            ...
                            <form action="${ route('data-pokdarkamtibmas.destroy', item.id) }" method="post" id="${ item.id }">
                                @method('delete')
                            @csrf
        ...
        const insertValueToFormEdit = ({
            ...
            elFormEdit.setAttribute('action', route('data-pokdarkamtibmas.update', id))
