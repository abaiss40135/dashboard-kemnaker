@extends('templates.admin-lte.sislap-non-harian', [
    ...
    'route_template' => route('data-komunitas-masyarakat.template-excel'),
    'route_import' => route('data-komunitas-masyarakat.import-excel'),
    'route_export' => route('data-komunitas-masyarakat.export-excel'),
    'route_store' => route('data-komunitas-masyarakat.store'),
    'route_search' => route('data-komunitas-masyarakat.search'),
    'route_destroy' => route('data-komunitas-masyarakat.destroy', 'id'),
    'laporan_exist' => isset($laporan),
    'model' => $model,
    'cite' => '',
])
@section('create_button')
    <a href="{{ route('data-komunitas-masyarakat.create') }}" class="btn btn-info">
        Tambah Data
    </a>
@endsection
        ...
        <table class="table table-hover table-bordered">
            <thead class="text-center bg-primary">
                <tr>
                    ...
                    <th rowspan="2" class="align-middle">Nama Komunitas Masyarakat</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input style="width: 200px;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][polda]" value="{{ $item[1] }}" required
                                        readonly>
                                </td>
                                <td>
                                    <input style="width: 200px;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][polres]" value="{{ $item[2] }}" required
                                        readonly>
                                </td>
                                <td>
                                    <input style="width: 250px;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][nama_kommas]" value="{{ $item[3] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 150px;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][akta_notaris]" value="{{ $item[4] }}"
                                    >
                                </td>
                                <td>
                                    @php
                                        try {
                                            if(strlen($item[5]) && strtolower($item[5]) !== 'nihil') {
                                    ...
                                    >
                                        ...
                                        @endphp
                                        ">
                                        <script>window.location.href = '{{route('data-komunitas-masyarakat.error-date', 'Akta Notaris')}}';</script>
                                        @php
                                            }
                                        @endphp
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][npwp]" value="{{ $item[6] }}">
                                </td>
                                <td>
                                    <input style="width: 50px; display: block;" type="number" class="form-control"
                                        name="laporan[{{ $key }}][rw]" value="{{ $item[7] }}" required>
                                </td>
                                <td>
                                    <input style="width: 50px; display: block;" type="number" class="form-control"
                                        name="laporan[{{ $key }}][rt]" value="{{ $item[8] }}" required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][desa]" value="{{ $item[9] }}" required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][kecamatan]" value="{{ $item[10] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][kabupaten]" value="{{ $item[11] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][provinsi]" value="{{ $item[12] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][jalan]" value="{{ $item[13] }}" required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][sumber_dana]" value="{{ $item[14] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][bidang_kegiatan]" value="{{ $item[15] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 75px; display: block;" type="number" class="form-control"
                                        name="laporan[{{ $key }}][jml_anggota]" value="{{ $item[16] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 250px; display: block;" type="text" class="form-control"
                                        name="laporan[{{ $key }}][nama_ketua]" value="{{ $item[17] }}"
                                        required>
                                </td>
                                <td>
                                    <input style="width: 200px; display: block;" type="number" class="form-control"
                                        name="laporan[{{ $key }}][no_hp_ketua]" value="{{ $item[18] }}"
                                        required>
                                </td>
                            </tr>
                        @endif
    ...
    <table class="table table-hover table-bordered">
        <thead class="bg-primary text-white text-center">
            <tr>
                ...
                <th class="align-middle">Nama Kommas</th>
                <th class="align-middle">No Akta Notaris</th>
                <th class="align-middle">NPWP</th>
                <th class="align-middle">Alamat</th>
                <th class="align-middle">Sumber Dana</th>
                <th class="align-middle">Bidang Kegiatan</th>
                <th class="align-middle">Jumlah Anggota</th>
                <th class="align-middle">Nama Ketua</th>
                <th class="align-middle">No HP Ketua</th>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @foreach ($sumber_dana as $key => $value)
                    <input type="checkbox" name="sumber_dana" id="sumber_dana_{{ $key }}"
                        value="{{ $value }}">
...
${ checklistApproval }
            ...
            <th class="align-middle">${ rowNumber }</th>
                        ...
                        <td class="align-middle text-center">${ item.nama_kommas }</td>
                        ...
                        <td class="align-middle text-center">${item.no_hp_ketua}</td>
            ...
            ${ `
                                                <button class="btn btn-edit btn-warning mb-1"
                                                        ...
                                                        onclick="insertValueToFormEditKommas('${ route('data-komunitas-masyarakat.update', item.id) }', {
                                                            polda               : '${item.polda}',
                                                            polres              : '${item.polres}',
            ...
            ${ !haveApprovals || !item.approval.is_approve ? `
                                            <form action="${ route('data-komunitas-masyarakat.destroy', item.id) }" method="post" id="${ item.id }">
                                                @method('delete')
                            @csrf
...
@endcanany
        ...
        function insertValueToFormEditKommas(r, fields) {
