    ...
    <div class="card" id="form-card">
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="nama_orsosmas">Nama Orsosmas</label>
                    <div class="col-lg-10">
                        <input type="text"
                            name="nama_orsosmas"
                            id="nama_orsosmas"
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="polres">Tipe Dasar Hukum</label>
                    <div class="col-lg-10">
                        <input type="radio"
                            name="type"
                            id="type_ahu"
                            ...
                            value="AHU">
                        <label for="type_ahu">AHU Kemenkumham</label>
                        <br>
                        <input type="radio"
                            name="type"
                            id="type_skt"
                            class="form-radio-label"
                            value="SKT">
                        <label for="type_skt">SKT Kemendagri</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="dasar_hukum">Nomor Dasar Hukum</label>
                    <div class="col-lg-10">
                        <input type="text"
                            name="dasar_hukum"
                            id="dasar_hukum"
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="tanggal_dasar_hukum">Tanggal Dasar Hukum</label>
                    <div class="col-lg-10">
                        <input type="date"
                            name="tanggal_dasar_hukum"
                            id="tanggal_dasar_hukum"
                            class="form-control">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function ignite() {
            ...
            function updateUI() {
                ...
                label.textContent = 'Nomor Sumber Hukum'
                ...
                for (let name in values) {
                    ...
                    if (name === 'sumber_dana') {
                        ...
                        if (input) input.checked = true
                        if (value === 'AHU') label.textContent = 'Nomor AHU Kemenkumham'
                        else if (value === 'SKT') label.textContent = 'SKT Kemendagri'
