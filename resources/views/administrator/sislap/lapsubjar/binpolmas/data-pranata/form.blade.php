<div>
    <div class="card" id="form-card">
        ...
        <div class="card-header d-flex bg-primary align-items-center justify-content-between">
            <h3 class="card-title w-50" id="data-pranata"></h3>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="nama_pranata">Nama Pranata Adat/Kearifan Lokal</label>
                    <div class="col-lg-10">
                        <input type="text"
                               name="nama_pranata"
                               id="nama_pranata"
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="nama_ketua_adat">Nama Ketua Adat</label>
                    <div class="col-lg-10">
                        <input type="text"
                               name="nama_ketua_adat"
                               id="nama_ketua_adat"
                               class="form-control"
                               required
                               maxlength="255">
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="no_hp_ketua_adat">No Handphone/WA Ketua Adat</label>
                    <div class="col-lg-10">
                        <input type="number"
                               name="no_hp_ketua_adat"
                               id="no_hp_ketua_adat"
                               class="form-control"
                               required>
                    </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <select name="pangkat_petugas_polmas" id="pangkat_petugas_polmas" class="form-control" required>
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="jumlah_anggota_pranata">Jumlah Anggota Pranata Adat/Kearifan Lokal</label>
                    <div class="col-lg-10">
                        <input type="number"
                               name="jumlah_anggota_pranata"
                               id="jumlah_anggota_pranata"
                               class="form-control"
                               required>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="balai_adat">Balai Adat</label>
                    <div class="col-lg-10">
                        <input type="radio"
                               name="balai_adat"
                               id="balai_adat_ada"
                               ...
                               value="Ada">
                        <label for="balai_adat_ada" for="type">Ada</label>
                        <br>
                        <input type="radio"
                               name="balai_adat"
                               id="balai_adat_tidak_ada"
                               class="form-radio-label"
                               value="Tidak Ada">
                        <label for="balai_adat_tidak_ada">Tidak Ada</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-lg-2" for="rw">RT</label>
                    <div class="col-lg-10">
                        <input type="text"
                               name="rt"
                               id="rt"
    ...
    <script>
        ...
        function ignite() {
            ...
            function reducer(state, action) {
                ...
                switch (action) {
                    case "ADD":
                        const addData = saveFormData('form-pranata');
                        state.data[state.position] = addData;
                        state.position = state.position + 1;
                        break;
                    case 'BACK':
                        const backData = saveFormData('form-pranata');
                    ...
                    case "DELETE":
                        ...
                        break;
                    case "SUBMIT":
                        state.data[state.position] = saveFormData('form-pranata');
                        const btnSubmit = document.querySelector('#form-pranata').querySelector('button[type="submit"]')
                ...
                document.getElementById('data-pranata').textContent = state.position + 1;
                return state;
            }
