...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="h4 text-center"><b>Data Senpi yang dimiliki Polsus</b></h2>
            @can('sipolsus_create')
        ...
        <div class="card-body">
            <form action="{{ route('data-senpi.export-excel') }}" class="form" method="post">
                @csrf
