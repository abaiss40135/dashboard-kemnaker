    ...
    <div class="wrapper">
        <div class="content-wrapper">
            @component('components.admin.content-header')
                @slot('title', 'Laporan Data Polsus Diklat Khusus Pensiunan TNI/Polri')
            @endcomponent
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <div>
                                <h2 class="h4 text-center"><b>Data Polsus Diklat Khusus Pensiunan TNI/Polri</b></h2>
                                <form action="{{ route('data-diklat-khusus.pensiunan-tni-polri.export-excel') }}"
...
{{--                                                    @endif--}}
                    ...
                    {{--                            </button>--}}
                                ...
                                @component('components.sislap.form-search')
                                    @slot('route', route('data-diklat-khusus.pensiunan-tni-polri.export-excel'))
...
@section('customjs')
    ...
    <script>
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('data-diklat-khusus.pensiunan-tni-polri.search'),
                data: {}
            },
                        ...
                        @forEach($attributes as $attribute)
                            <td class="align-middle">
                                ...
                                `<div class="d-flex justify-content-center" style="width: max-content">
                                    <span>${ item[`${jenis_polsus}{{'_' . $attribute}}`] }<span> ${`<button type="button" class="btn btn-info btn-sm" onclick="detailPolsus(this)" data-polsuswilayah="${jenis_polsus},{{$attribute}},${item.provinsi},${item.kotakab},khusus_tni_polri" class="btn btn-sm btn-info"><i class="fas fa-info-circle"></i></button>`}
                                </div>`
                    ...
                    @foreach($polices as $police)
                        @foreach($attributes as $attribute)
                            <td class="align-middle">
                                ...
                                `<div class="d-flex justify-content-center" style="width: max-content">
                                    <span class="mr-3">${ {{"item.{$police}_{$attribute}"}} }<span> ${ `<button type="button" class="btn btn-info btn-sm" onclick="detailPolsus(this)" data-polsuswilayah="{{$police}},{{$attribute}},${item.provinsi},${item.kotakab},khusus_tni_polri" class="btn btn-sm btn-info"><i class="fas fa-info-circle"></i></button>` }
                                </div>`
