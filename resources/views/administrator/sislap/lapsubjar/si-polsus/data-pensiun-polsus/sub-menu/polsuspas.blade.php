@extends('templates.admin-lte.admin', ['title' => 'Data Anggota Aktif dan Pensiun Polsuspas'])
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="h4 text-center"><b>Data Anggota Aktif dan Pensiun Polsuspas</b></h2>
        </div>
        <div class="card-body">
            <form action="{{ route('data-pensiun-polsus.polsuspas.export-excel') }}" class="form" method="post">
                @csrf
...
{{--                            </button>--}}
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered">
                    ...
                    <tr class="bg-primary text-white text-center">
                        ...
                        <th class="align-middle">Nama Lapas</th>
    ...
    @include('administrator.sislap.lapsubjar.si-polsus.data-pensiun-polsus.sub-menu.modal.modal-data-pensiun-polsus', ['route' => 'data-pensiun-polsus.polsuspas.data-polsus-pensiun'])
...
@section('customjs')
    ...
    <script>
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('data-pensiun-polsus.polsuspas.search'),
                data: {}
            },
