@extends('templates.admin-lte.admin', ['title' => 'Data Anggota Aktif dan Pensiun Polsus Barantan'])
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="h4 text-center"><b>Data Anggota Aktif dan Pensiun Polsus Barantan</b></h2>
        </div>
        <div class="card-body">
            <form action="{{ route('data-pensiun-polsus.polsus-barantan.export-excel') }}" class="form" method="post">
                @csrf
...
{{--                            </button>--}}
    ...
    @include('administrator.sislap.lapsubjar.si-polsus.data-pensiun-polsus.sub-menu.modal.modal-data-pensiun-polsus', ['route' => 'data-pensiun-polsus.polsus-barantan.data-polsus-pensiun'])
...
@section('customjs')
    ...
    <script>
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('data-pensiun-polsus.polsus-barantan.search'),
                data: {}
            },
