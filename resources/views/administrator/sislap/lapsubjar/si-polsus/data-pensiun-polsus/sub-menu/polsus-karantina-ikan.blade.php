@extends('templates.admin-lte.admin', ['title' => 'Data Anggota Aktif dan Pensiun Polsus Karantina Ikan'])
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="h4 text-center"><b>Data Anggota Aktif dan Pensiun Polsus Karantina Ikan</b></h2>
        </div>
        <div class="card-body">
            <form action="{{ route('data-pensiun-polsus.polsus-karantina-ikan.export-excel') }}" class="form" method="post">
                @csrf
...
{{--                            </button>--}}
    ...
    @include('administrator.sislap.lapsubjar.si-polsus.data-pensiun-polsus.sub-menu.modal.modal-data-pensiun-polsus', ['route' => 'data-pensiun-polsus.polsus-karantina-ikan.data-polsus-pensiun'])
...
@section('customjs')
    ...
    <script>
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('data-pensiun-polsus.polsus-karantina-ikan.search'),
                data: {}
            },
