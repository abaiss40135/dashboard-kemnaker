    ...
    <div class="wrapper">
        <div class="content-wrapper">
            @component('components.admin.content-header')
                @slot('title', 'Laporan Data Senpi dan Amunisi Berdasarkan Satuan Polisi Khusus')
            @endcomponent
            <section class="content">
                <div class="container-fluid row mx-0 justify-content-center">
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsuspas')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsuspas.index')}}" class="card">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polhut_lhk')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polhut-lhk.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polhut_perhutani')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polhut-perhutani.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsus_cagar_budaya')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsus-cagar-budaya.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsuska')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsuska.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                                        <img width="140px" height="100px" src="https://1.bp.blogspot.com/-gcPW4R5n3hs/YKzMAOc8bwI/AAAAAAAAFEA/9jH2ImUDmkATv85lfi5N_My63hJyQTxnQCLcBGAsYHQ/s1600/Logo%2BKAI%2B%2528Kereta%2BApi%2BIndonesia%2529.png" alt="">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsus_pwp3k')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsus-pwp3k.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsus_karantina_ikan')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsus-karantina-ikan.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsus_barantan')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsus-barantan.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsus_dishubdar')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsus-dishubdar.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                    ...
                    @if($isAdmin || $isOperatorPolda || $aksesPolsus == 'polsus_satpol_pp')
                        <div class="col-sm-6 col-md-4">
                            <a href="{{route('data-senpi-amunisi.polsus-satpol-pp.index')}}" class="card">
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <div class="d-flex flex-column p-3 align-items-center">
                                        <img width="100px" src="https://satpolpp.ngawikab.go.id/wp-content/uploads/2022/11/cropped-logo-satpolpp.png" alt="">
