@extends('templates.admin-lte.admin', ['title' => 'Data Senpi dan Amunisi Milik Polsus Karantina Ikan'])
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="h4 text-center"><b>Data Senpi dan Amunisi yang dimiliki Polsus Karantina Ikan</b></h2>
            @if(!auth()->user()->haveRole('operator_polsus_polda') && can('sipolsus_create'))
                <div style="position: absolute; right: 0.8rem; top: 0.8rem;">
                    <a href="{{ route('input-data-senpi-amunisi.index', 'polsus-karantina-ikan') }}">
        ...
        <div class="card-body">
            <form action="{{ route('data-senpi-amunisi.polsus-karantina-ikan.export-excel') }}" class="form" method="post">
                @csrf
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered">
                    ...
                    <tr class="bg-primary text-white text-center">
                        ...
                        @endforeach
                        <th class="alignn-middle">Action</th>
                    </tr>
                    </thead>
...
@section('customjs')
    ...
    <script>
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('data-senpi-amunisi.polsus-karantina-ikan.search'),
                data: {}
            },
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center" rowspan="2">
                            <button onclick="editSenpiAmunisi({
                                jenis_polsus: 'polsus_karantina_ikan',
                            ...
                            <form action="${route('input-data-senpi-amunisi.destroy', ['polsus_karantina_ikan', item.senpi.id_data, item.amunisi.id_data])}" method="post" id="form-delete">
                                @csrf
                                @method('delete')
