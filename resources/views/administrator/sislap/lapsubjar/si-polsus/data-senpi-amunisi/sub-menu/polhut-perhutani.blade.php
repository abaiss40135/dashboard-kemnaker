@extends('templates.admin-lte.admin', ['title' => 'Data Senpi dan Amunisi Milik Polhut Perhutani'])
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="h4 text-center"><b>Data Senpi dan Amunisi yang dimiliki Polhut Perhutani</b></h2>
            @if(!auth()->user()->haveRole('operator_polsus_polda') && can('sipolsus_create'))
                <div style="position: absolute; right: 0.8rem; top: 0.8rem;">
                    <a href="{{ route('input-data-senpi-amunisi.index', 'polhut-perhutani') }}">
        ...
        <div class="card-body">
            <form action="{{ route('data-senpi-amunisi.polhut-perhutani.export-excel') }}" class="form" method="post">
                @csrf
...
{{--                                @endif--}}
                            ...
                            <div class="col-lg-4 col-md-6 mt-lg-0 mt-3">
                                <input type="text" id="search" name="search" class="form-control"
                                       placeholder="Cari data berdasarkan Nama Divisi Regional">
                            </div>
                        </div>
                    </div>
                    <div class="form-group w-100">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered">
                    ...
                    <tr class="bg-primary text-white text-center">
                        ...
                        <th class="align-middle" rowspan="2">Nama Divisi Regional</th>
...
@section('customjs')
    ...
    <script>
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('data-senpi-amunisi.polhut-perhutani.search'),
                data: {}
            },
            content: (item, rowNumber) => {
                let table = `
                    <tr>
                        ...
                        <td class="align-middle" rowspan="2">${item.kategori}</td>
                        ...
                        <td class="align-middle text-center" rowspan="2">
                            ...
                            <form action="${route('input-data-senpi-amunisi.destroy', ['polhut_perhutani', item.senpi.id_data, item.amunisi.id_data])}" method="post" id="form-delete">
                                @csrf
                                @method('delete')
