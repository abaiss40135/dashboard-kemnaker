@extends('templates.admin-lte.sislap', [
    'title'          => 'LAPORAN HASIL KEGIATAN OPERASI KASUARI',
    'route_template' => route('cartenz.kasuari.template-excel'),
    'route_import'   => route('cartenz.kasuari.import-excel'),
    'route_export'   => route('cartenz.kasuari.export-excel'),
    'route_store'    => route('cartenz.kasuari.store'),
    'route_search'   => route('cartenz.kasuari.search'),
    'route_destroy'  => route('cartenz.kasuari.destroy', 'id'),
                    ...
                    <td class="align-middle text-center">
                        ...
                        ${ haveApprovals && !item.need_approve ? `` : `
                            <button class="btn btn-edit btn-warning mb-1"
                                    ...
                                    onclick="insertValueToFormEdit('${route('cartenz.kasuari.update', item.id)}', {
                                        daops      : '${item.daops}',
                                        satgas     : '${item.satgas}',
                                        jam        : '${item.jam}',
                        ...
                        <form action="${ route('cartenz.kasuari.destroy', item.id) }" method="post" id="${ item.id }">
                            @method('delete')
                        @csrf
