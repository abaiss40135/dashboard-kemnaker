    ...
    <div class="card">
        <div class="card-header py-3">
            <div class="d-flex justify-content-stretch justify-content-sm-start">
                <div class="pr-3">
                    <a href="{{ route('penanganan-pasca-gempa-cianjur.create') }}" class="btn btn-success">Tambah Laporan</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            @can('sislap_approval_create')
                <button type="button" class="btn btn-primary" id="btn-ajukan-approval">
                    ...
                    @if (role('operator_bagopsnalev_polres'))
                        ke Polda
                    @endif
...
@section('customjs')
    ...
    <script>
        ...
        const listLaporan = new ComponentWithPagination({
            ...
            searchState: {
                url: route('penanganan-pasca-gempa-cianjur.search'),
                data: {}
            },
                        ...
                        <td class="align-middle text-center">
                            ...
                            @can('lapsubjar_edit')
                                ${ haveApprovals && !item.need_approve ? `` : `
                                    <a href="${ route('penanganan-pasca-gempa-cianjur.edit', item.id) }"
                            ...
                            @can('lapsubjar_destroy')
                                ...
                                <form action="${ route('penanganan-pasca-gempa-cianjur.destroy', item.id) }" method="post" id="${ item.id }">
                                    @method('delete')
                                    @csrf
