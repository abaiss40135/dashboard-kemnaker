...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-4">
        <x-recap-link
            ...
            icon="fa-coins"
            bg="bg-primary-light"
            attrs="data-modal-target='kemnaker-modal' data-modal-toggle='kemnaker-modal'"
        />
        <x-recap-link
            title="Rekapitulasi Barang Milik Negara (BMN)"
            icon="fa-luggage-cart"
            bg="bg-info-light"
            attrs="data-modal-target='kemnaker-modal' data-modal-toggle='kemnaker-modal'"
        />
        <x-recap-link
            title="Rekapitulasi Target Key Performance Indicator (KPI)"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
        <x-recap-link
            title="Rekapitulasi Tindak Lanjut Hasil Pemeriksaan (TLHP)"
            icon="fa-forward"
            bg="bg-danger-light"
            attrs="data-modal-target='kemnaker-modal' data-modal-toggle='kemnaker-modal'"
        />
        <x-recap-link
            title="Status Pengelolaan Proyek"
            icon="fa-tasks"
            bg="bg-dark"
            attrs="data-modal-target='kemnaker-modal' data-modal-toggle='kemnaker-modal'"
        />
            ...
            <div class="relative bg-white rounded-lg shadow">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                    ...
                    <button
                        ...
                        data-modal-hide="kemnaker-modal"
                    >
