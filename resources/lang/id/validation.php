...
return [
    ...
    */
    ...
    'custom' => [
        'pendapat.0.bidang_pendapat' => [
            'required' => 'Bidang pendapat pada jenis pendapat keluhan wajib diisi.',
            'required_if' => 'Bidang pendapat pada jenis pendapat keluhan wajib diisi.',
        ],
        'pendapat.0.uraian' => [
            'required' => 'Bidang pendapat pada jenis pendapat keluhan wajib diisi.',
            'required_if' => 'Uraian pada jenis pendapat keluhan wajib diisi.',
        ],
        'pendapat.0.keyword' => [
            'required' => 'Bidang pendapat pada jenis pendapat keluhan wajib diisi.',
            'required_if' => 'Keyword pada jenis pendapat keluhan wajib diisi.',
        ],
        'pendapat.1.bidang_pendapat' => [
            'required' => 'Bidang pendapat pada jenis pendapat harapan wajib diisi.',
            'required_if' => 'Bidang pendapat pada jenis pendapat harapan wajib diisi.',
        ],
        'pendapat.1.uraian' => [
            'required' => 'Bidang pendapat pada jenis pendapat harapan wajib diisi.',
            'required_if' => 'Uraian pada jenis pendapat harapan wajib diisi.',
        ],
        'pendapat.1.keyword' => [
            'required' => 'Bidang pendapat pada jenis pendapat harapan wajib diisi.',
            'required_if' => 'Keyword pada jenis pendapat harapan wajib diisi.',
        ],
        'role_id' => [
            'required' => 'Hak Akses wajib diisi.',
            'exists'=> 'Hak Akses yang dipilih tidak valid.'
        ],
        'new_password'=> [
            'required' => 'Password baru wajib diisi.'
        ],
        'g-recaptcha-response' => [
            'required' => 'validasi captcha gagal',
        ]
    ],
