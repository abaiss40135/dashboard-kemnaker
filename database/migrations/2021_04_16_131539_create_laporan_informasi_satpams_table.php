...
class CreateLaporanInformasiSatpamsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('laporan_informasi_satpams', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('laporan_informasi_satpams');
    }
}
