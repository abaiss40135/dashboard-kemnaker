...
class ChangeUrgensiToDdsWargas extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('dds_wargas', function (Blueprint $table) {
            ...
            $table->string('keyword')->nullable()->default('...')->change();
            ...
            $table->string('no_tel_kepala_keluarga')->nullable()->default('...')->change();
